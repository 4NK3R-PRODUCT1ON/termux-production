#!/usr/bin/python2
# Author : ./ANKER
# Team : Cyber ARMY Indonesian( BCA - X666X )
# Apa Liat Liat ? Mau Recode ? >_<
# Recode akan mendapat dosa dari alloh amin+corona
...
\____/| .__/ \__,_|_| |_| |_| \____/|_| |_| |_|___/
	...
	def Spam():
		...
		if PilihTools == '1':
			...
			os.system('xdg-open +1 (234)985-0607')
...
if __name__ == '__main__':
	print(C+'Subscribe YT'+W+' Gua Dlu Ya Cok !'+C+' :V')
	sleep(2)
	os.system('clear')
